'''
in Player.py, declare a 'Player' class that is a subclass of pygame Sprite
add __init__, update, left, and right
'''
...
class Player(pygame.sprite.Sprite):
    ...
    def update(self, platforms):
      ...
      '''
      if self.rect.right is negative: set self.rect.left to the current width of the screen
elif self.rect.left is greater than the current width of the screen
set self.rect.right to 0
